...
namespace MainBit.Projections.ClientSide.Providers.Filters
{
    public class ContentFieldsFilter : IFilterProvider
    {
        ...
        public void ApplyFilter(FilterContext context, IVariableFieldTypeEditor fieldTypeEditor, string storageName, Type storageType, ContentPartDefinition part, ContentPartFieldDefinition field)
        {
