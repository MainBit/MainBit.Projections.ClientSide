...
namespace MainBit.Projections.ClientSide.FieldTypeEditors {
    ...
    /// </summary>
    public class StringVariableFieldTypeEditor : IVariableFieldTypeEditor
    {
        public Localizer T { get; set; }

        public StringVariableFieldTypeEditor()
        {
        ...
        public Action<IHqlExpressionFactory> GetFilterPredicate(dynamic formState) {
            return StringVariableFilterForm.GetFilterPredicate(formState, "Value");
        }

        public LocalizedString DisplayFilter(string fieldName, string storageName, dynamic formState) {
            return StringVariableFilterForm.DisplayFilter(fieldName + " " + storageName, formState, T);
        }
